...
{
    public class NononZoneController : MonoBehaviour
    {
        ...
        public void ResetPlayerPos()
        {
            ...
            {
                // if it is single player, only one object with Player TAG should exist
                player.GetComponent<PlayerController>().ResetPlayer(GetSpawnPosition(), GetSpawnRotation());
                break;
            }
