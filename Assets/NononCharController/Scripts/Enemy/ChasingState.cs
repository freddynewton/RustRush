...
namespace zone.nonon
{
    public class ChasingState : State
    {
        ...
        public PatrolingState patrolingState;
            ...
            if (enemy != null)
            {
                ...
                else
                {
                    if (enemy.GetAggroObject() != null)
                    {
                        ...
                        NononZoneObject enemyNoNoNZoneObject;
                        if (enemyTarget.TryGetComponent<NononZoneObject>(out enemyNoNoNZoneObject))
                        {
                    ...
                    else
                    {
                        ...
                        if (enemyTarget != null && enemyTarget.TryGetComponent<NononZoneObject>(out no))
                        {
