...
{
    public class RelayManager : NononSingleton<RelayManager>
    {
        [SerializeField]
        ...
        {
            NononLogger.Instance.LogDebug($"Relay Server Starting with max connections {maxConnections}");
            ...
            NononLogger.Instance.LogDebug($"Relay Server generated Join Code {relayHostData.JoinCode}");
        ...
        public async Task<RelayJoinData> JoinRelay(string joinCode)
        {
            ...
            NononLogger.Instance.LogDebug("Try joining with code: " + joinCode);
            ...
            NononLogger.Instance.LogDebug($"Client Joined game with JoinCode {joinCode}");
