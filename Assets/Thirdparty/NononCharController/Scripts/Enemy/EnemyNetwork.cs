...
namespace zone.nonon
{
    public class EnemyNetwork : NetworkBehaviour
    {
        ...
        DmgHealthTextControllerNetwork dmgHealthTextController;
        ...
        void Start()
        {
            ...
            dmgHealthTextController = GetComponent<DmgHealthTextControllerNetwork>();
        }
        ...
        [ClientRpc]
        public void SetEyeLookClientRpc(bool _aggro)
        {
